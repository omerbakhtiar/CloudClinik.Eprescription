...
public class SameDiease {
		...
		public void setAdditionalDiagnosis() throws InterruptedException {
			...
			dental.save();
			Thread.sleep(3000);
			Assert.assertTrue(dental.FMMMessage("Primary disease in a row can't be added as Additional Disease. Please review your Prescription."));
		}
}
